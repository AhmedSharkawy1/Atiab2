    ...
    <header className="relative z-50 bg-white dark:bg-[#050505] border-b border-zinc-200 dark:border-white/10 pt-[env(safe-area-inset-top,0px)]">
      <div className="max-w-2xl mx-auto px-5 py-4 md:py-6 text-right">
        ...
        <div className="flex w-full gap-3 relative">
          ...
          <a
            href="https://wa.me/201044168230"
            className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-white font-black py-4 rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-[0.96] shadow-xl text-[14px] border border-yellow-400/20"
          >
